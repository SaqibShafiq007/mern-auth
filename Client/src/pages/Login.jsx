...
function Login() {
  ...
  const onSubmitHandler = async (e) => {
    try {
        ...
        // Allow axios to send cookies (tokens) to the backend
    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <div className='bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form onSubmit = {onSubmitHandler}>
          ...
          <p onClick={()=> navigate('/reset-password')} className='w-full mb-4 text-indigo-500 cursor-pointer'> Forgot Password?</p>
        ...
        {state === 'Sign Up' ? 
        (
          <p className='text-grey-400 text-center text-xs mt-4'> Alread have an account? {' '}
